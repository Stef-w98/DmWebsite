window.addEventListener('load', async () => {
    ...
    const addCity = async (name, latitude, longitude) => {
        ...
        // Since we cannot check response.ok or read the response body,
        // we won't know if the request was successful or not.
        console.log('City sent for addition (response is opaque due to no-cors mode)');
    };
